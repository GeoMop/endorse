# "Chodby" project - detailed model of water pressure tests on single borehole interval
...
### mesh
Geometry and mesh preprocessing.

### [input_data](input_data/README.md)
Input data.

### model 
Hydro-mechanical model of chamber pore pressures.
